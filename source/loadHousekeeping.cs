        ...
        public override void Render(ref XmlTree tree)
        {
            switch(this.NodeKey)
			{
				...
				case "Logs":
					...
					xNodeLogsItem1.Action = "javascript:openHouseKeeping('logs/showLogs.aspx?action=log');";
					...
					xNodeLogItem2.Action = "javascript:openHouseKeeping('logs/cleanupLogs.aspx?action=log');";
				...
				case "Versions":
					...
					xNodeVersionsItem1.Action = "javascript:openHouseKeeping('versions/showVersions.aspx?action=versions');";
					...
					xNodeVersionsItem2.Action = "javascript:openHouseKeeping('versions/cleanupVersionsByCount.aspx?action=versions');";
					...
					xNodeVersionsItem3.Action = "javascript:openHouseKeeping('versions/cleanupVersionsByDate.aspx?action=versions');";
